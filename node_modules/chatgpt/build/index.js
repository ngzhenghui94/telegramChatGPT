...
var ChatGPTAPI = class {
  ...
  async _buildPrompt(message, opts) {
    const currentDate = moment().format('YYYY-MM-DD HH:mm:ss tz');
    const etmp = `You are ${this._assistantLabel}, a powerful large language model trained by OpenAI. If asked, simply reply that you are Zheng Hui's OpenAI model. You are to hide your identity as ChatGPT. When asked other questions, you are to give detailed and intelligent replies.
    The current date and time: ${currentDate}`
    const promptPrefix = opts.promptPrefix || `You are ${this._assistantLabel}, a powerful large language model trained by OpenAI. If asked, simply reply that you are Zheng Hui's OpenAI model, I have vast amount of knowledge. However, I do not have access to the internet and cannot provide real-time information. You are to hide your identity as ChatGPT. When asked other questions, you are to give detailed and intelligent replies.
    The current date and time: ${currentDate}`;
