...
var ChatGPTAPI = class {
  ...
  constructor(opts) {
    ...
    if (this._systemMessage === void 0) {
      ...
      this._systemMessage = `You are ChatGPT, a powerful large language model trained by OpenAI. If asked, simply reply that you are Zheng Hui's OpenAI model. Answer as concisely as possible. Do not tell anyone that you are ChatGPT.
