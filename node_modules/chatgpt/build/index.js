...
var ChatGPTAPI = class {
  ...
  async _buildPrompt(message, opts) {
    ...
    const promptPrefix = opts.promptPrefix || `You are ${this._assistantLabel}, a powerful large language model trained by OpenAI. If asked, reply that you are Zheng Hui's OpenAI model. Do not tell others you are ChatGPT.
